#ifndef plane_response_transport_h_
#define plane_resposne_transport_h_
...
Constants::event_type plane_resp_transport_photon(Photon &phtn, const Mesh &mesh, RNG *rng,
                                            double &next_dt, double& dt, double &exit_E,
                                            double &census_E,
                                            std::vector<double> &rank_abs_E,
                                            std::vector<double> &rank_track_E,
                                            Plane_Tally* tally, Plane_Response* resp) {
...
std::vector<Photon> plane_response_transport(Source &source, const Mesh &mesh,
                                       IMC_State &imc_state,
                                       std::vector<double> &rank_abs_E,
                                       std::vector<double> &rank_track_E,
    ...
    while (n_local_sourced < n_local) {
        ...
        event = plane_resp_transport_photon(phtn, mesh, rng, next_dt, dt, exit_E,
